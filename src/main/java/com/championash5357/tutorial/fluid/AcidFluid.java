...
public abstract class AcidFluid extends FlowingFluid {
	...
	public Fluid getFlowingFluid() {
		return TutorialFluids.FLOWING_ACID.get();
	}

	@Override
	public Fluid getStillFluid() {
		return TutorialFluids.ACID.get();
	}
	...
	public Item getFilledBucket() {
		return TutorialItems.ACID_BUCKET.get();
	}
	...
	protected BlockState getBlockState(IFluidState state) {
		return TutorialBlocks.ACID.get().getDefaultState().with(FlowingFluidBlock.LEVEL, Integer.valueOf(getLevelFromState(state)));
	}
	
	@Override
	public boolean isEquivalentTo(Fluid fluidIn) {
		return fluidIn == TutorialFluids.ACID.get() || fluidIn == TutorialFluids.FLOWING_ACID.get();
	}
	...
	public static class Flowing extends AcidFluid {
		...
		public int getLevel(IFluidState state) {
			return state.get(AcidFluid.LEVEL_1_8);
		}
