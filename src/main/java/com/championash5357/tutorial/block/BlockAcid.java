...
public class BlockAcid extends FlowingFluidBlock {

	public BlockAcid() {
		super(() -> TutorialFluids.ACID, Block.Properties.create(Material.WATER).doesNotBlockMovement().hardnessAndResistance(100.0F).noDrops());
		this.setRegistryName(Tutorial.MOD_ID, "acid");
	}
