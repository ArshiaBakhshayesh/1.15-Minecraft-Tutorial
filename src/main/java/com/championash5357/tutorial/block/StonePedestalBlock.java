...
public class StonePedestalBlock extends Block {
	...
	public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockRayTraceResult hit) {
		StonePedestalTileEntity pedestal = (StonePedestalTileEntity) world.getTileEntity(pos);
	...
	public void harvestBlock(World worldIn, PlayerEntity player, BlockPos pos, BlockState state, TileEntity te, ItemStack stack) {
		StonePedestalTileEntity pedestal = (StonePedestalTileEntity) te;
	...
	public TileEntity createTileEntity(BlockState state, IBlockReader world) {
		return new StonePedestalTileEntity();
	}
}
