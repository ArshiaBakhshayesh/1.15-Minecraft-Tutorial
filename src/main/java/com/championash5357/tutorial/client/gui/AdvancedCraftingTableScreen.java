...
public class AdvancedCraftingTableScreen extends ContainerScreen<AdvancedCraftingTableContainer> {
	...
	public AdvancedCraftingTableScreen(AdvancedCraftingTableContainer table, PlayerInventory player, ITextComponent title) {
