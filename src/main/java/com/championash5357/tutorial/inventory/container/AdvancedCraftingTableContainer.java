...
public class AdvancedCraftingTableContainer extends Container {
	...
	public AdvancedCraftingTableContainer(final int windowID, PlayerInventory player) {
		this(windowID, player, new AdvancedCraftingTableTileEntity(), IWorldPosCallable.DUMMY);
	}
	
	public AdvancedCraftingTableContainer(final int windowID, PlayerInventory player, AdvancedCraftingTableTileEntity table, IWorldPosCallable callable) {
		super(TutorialContainers.ADVANCED_CRAFTING_TABLE.get(), windowID);
		this.table = table;
