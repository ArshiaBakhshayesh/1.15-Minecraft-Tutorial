...
public class ContainerStorage extends Container {
	...
	public ContainerStorage(final int windowID, PlayerInventory player) {
		this(windowID, player, new TileEntityStorage());
	}
	
	public ContainerStorage(final int windowID, PlayerInventory player, TileEntityStorage storage) {
		super(TutorialContainers.STORAGE, windowID);
