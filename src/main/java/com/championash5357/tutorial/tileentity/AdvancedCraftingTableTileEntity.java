...
public class AdvancedCraftingTableTileEntity extends TileEntity {

	private ItemStackHandler inventory = new ItemStackHandler(25);
	
	public AdvancedCraftingTableTileEntity() {
		super(TutorialTileEntities.ADVANCED_CRAFTING_TABLE.get());
	}
